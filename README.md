...
### Hardware
We trained our models on a scientific workstation with 24 logical cores, 128GB of ram, and 3 NVIDIA RTX A6000 GPUs. This was just enough memory to fine-tune all layers of EfficiententV2S on images 600 by 600 pixels in size in minibatches of 12 (3 per card); if your GPU has more or less memory, you may want to change the image size, minibatch size, and/or flavor of EfficientNet to suit your needs, especially if you plan to do extensive hyperparameter tuning or other kinds of compute-heavy experimentation.
